...
export const translations = {
  en: {
    ...
    business_hardware_store: "Hardware store",
    business_retail_store: "Retail store",
    business_restaurant: "Restaurant",
    business_distributor: "Distributor / wholesaler",
    start_free_trial: "Start free trial",
    trial_signup_description: "Create your store and try VENDR free for 14 days. No card required.",
    complete_security_check: "Complete the security check to continue.",
    trial_not_available: "Self-service trials are not available right now.",
    start_trial_days: "Start {days}-day free trial",
    trial_check_email: "Check your email",
    trial_email_sent: "We sent a verification link to {email}. Your store will be created after you verify it.",
    trial_link_expires: "The verification link expires in 30 minutes.",
    trial_verifying: "Creating your trial...",
    trial_verifying_description: "Your email is verified. VENDR is preparing your store.",
    trial_verification_failed_title: "We could not start the trial",
    trial_verification_failed: "This verification link is invalid or expired. Request a new one.",
    trial_banner_days: "Free trial: {days} day(s) remaining",
    trial_banner_read_only: "Your free trial has ended. Your data is safe and available to review, but changes are disabled.",
    trial_landing_eyebrow: "RUN YOUR STORE WITH LESS GUESSWORK",
    trial_landing_heading: "Your store, organized from day one.",
    trial_landing_subheading: "Sales, inventory, purchasing, cash control, and clear reports in one practical workspace built for everyday retail.",
    trial_landing_no_card: "14 days free · No card required",
    trial_landing_included: "Everything you need to test VENDR",
    trial_landing_feature_sales: "Fast point of sale with searchable products and auditable history.",
    trial_landing_feature_inventory: "Live inventory, low-stock reminders, reorders, intakes, and adjustments.",
    trial_landing_feature_reports: "Performance, profitability, and weekly reporting grounded in your own data.",
    trial_landing_feature_offline: "Offline protection that queues supported work when connectivity is unreliable.",
    trial_landing_existing_data: "Already use VENDR? Sign in normally. Existing stores are not affected by trials.",
    trial_onboarding_eyebrow: "WELCOME TO VENDR",
    trial_onboarding_title: "Set up your first real workflow",
    trial_onboarding_description: "Start with one product and one sale. You can explore everything else after the basic loop makes sense.",
    trial_onboarding_products: "Create or import your first products",
    trial_onboarding_cash: "Set the register opening amount",
    trial_onboarding_sale: "Try a sale in POS",
    trial_onboarding_products_instruction: "Open Create, enter one real product, and save it. You can also import a product list.",
    trial_onboarding_cash_instruction: "Select Adjust Register, choose Increase, and enter the cash currently in the register.",
    trial_onboarding_sale_instruction: "Create a ticket, add a product, review the quantity and price, then confirm the sale.",
    trial_onboarding_progress: "Setup: {done} of {total} complete",
    trial_onboarding_continue: "Continue setup",
    trial_onboarding_complete: "Your first workflow is ready",
    trial_onboarding_complete_short: "Setup complete",
    trial_onboarding_complete_description: "You have completed the basic VENDR loop. You can review any step or explore the rest of the system.",
    trial_onboarding_later: "Explore on my own",
    trial_admin_eyebrow: "PLATFORM ADMINISTRATION",
    trial_admin_title: "Self-service trials",
    trial_admin_back: "Back to VENDR",
    trial_admin_store: "Store",
    trial_admin_contact: "Contact",
    trial_admin_started: "Started",
    trial_admin_expires: "Expires",
    trial_admin_status: "Status",
    trial_admin_active: "Active trial",
    trial_admin_expired: "Expired / read-only",
    trial_admin_paid: "Converted",
    trial_admin_convert: "Mark as paid",
    trial_admin_convert_confirm: "Convert {store} to a paid account? This immediately restores write access.",
    trial_admin_load_failed: "Unable to load trial stores.",
    trial_admin_convert_failed: "Unable to convert this trial.",
    trial_admin_empty: "No self-service trials have been created yet.",
    subscription_admin_title: "Subscriptions",
    subscription_admin_intro: "Track trials, payments, renewal periods, and accounts that need attention.",
    subscription_summary_trials: "Active trials",
    subscription_summary_active: "Active subscriptions",
    subscription_summary_attention: "Needs attention",
    subscription_filter_attention: "Needs attention",
    subscription_paid_through: "Paid through",
    subscription_grace_until: "Grace until",
    subscription_last_payment: "Last payment",
    subscription_record_payment: "Record payment",
    subscription_history: "Payment history",
    subscription_no_payments: "No subscription payments have been recorded.",
    subscription_payment_failed: "Unable to record the payment.",
    subscription_history_failed: "Unable to load payment history.",
    subscription_cancel: "Cancel renewal",
    subscription_cancel_confirm: "Cancel renewal for {store}? Access continues through the paid period, but no grace period will be granted.",
    subscription_cancel_failed: "Unable to cancel the subscription.",
    subscription_resume: "Resume renewal",
    subscription_resume_failed: "Unable to resume the subscription.",
    subscription_amount: "Amount paid (USD)",
    subscription_months: "Months granted",
    subscription_months_short: "month(s)",
    subscription_payment_date: "Payment date",
    subscription_payment_method: "Payment method",
    subscription_reference: "Reference",
    subscription_period: "Access period",
    subscription_method_cash: "Cash",
    subscription_method_bank_transfer: "Bank transfer",
    subscription_method_wompi: "Wompi",
    subscription_method_other: "Other",
    subscription_status_trial_active: "Active trial",
    subscription_status_trial_expired: "Trial expired",
    subscription_status_paid_unmanaged: "Converted · not tracked",
    subscription_status_active: "Active",
    subscription_status_due_soon: "Due soon",
    subscription_status_grace: "Grace period",
    subscription_status_past_due: "Past due · read-only",
    subscription_status_canceled_active: "Canceled · active through period",
    subscription_status_canceled: "Canceled · read-only",
    subscription_status_inactive: "Inactive",
    subscription_banner_due_soon: "Subscription renewal is due on {date}.",
    subscription_banner_grace: "Payment is overdue. Access remains active through {date}.",
    subscription_banner_read_only: "Your subscription is not active. Your data is safe and available to review, but changes are disabled. Contact VENDR to renew.",
    subscription_banner_canceled: "Your subscription will end on {date}. Your data will remain available to review.",
    help: "Help",
    help_eyebrow: "VENDR SUPPORT",
    help_center: "Help center",
    help_intro: "Find a task, open its instructions, and jump directly to the related workflow.",
    help_search_placeholder: "Search questions or tasks...",
    help_take_me_there: "Take me there",
    help_watch_tutorial: "Watch tutorial",
    help_no_results: "No help topics match that search.",
    logout: "Log out",
    store: "Store",
    change: "Change",
    subtotal: "Subtotal",
...
organization_report_load_failed:
  "Unable to load the organization report.",
    ...
    ai_reporting_not_enabled: "AI reporting is not enabled for this store",
    ai_reporting_not_enabled_help: "Enable the store before generating its first weekly briefing.",
    ai_reporting_not_configured: "AI reporting is not configured",
    ai_reporting_not_configured_help: "Add the OpenAI API key to the backend environment before generating reports.",
    ai_report_load_failed: "Could not load weekly reports.",
    ai_report_generate_failed: "Could not generate the weekly report.",
    no_weekly_reports: "No weekly briefings yet",
    generate_weekly_report_help: "Generate an analysis of the most recently completed Monday–Sunday week.",
    generate_weekly_report: "Generate last week’s report",
    generating_report: "Generating report…",
    report_period: "Report period",
    select_weekly_report: "Select weekly report",
    ...
    concerns: "Concerns",
    no_concerns: "No concerns were identified.",
    recommended_actions: "Recommended actions",
    data_limitations: "Data limitations",
    ai_report_disclaimer: "AI interpretation based only on VENDR-calculated store data. Review recommendations before acting.",
    alerts: "Alerts",
    growth: "Growth",
    stability: "Stability",
    shrinking: "Shrinking",
  ...
  es: {
    ...
    business_hardware_store: "Ferretería",
    business_retail_store: "Tienda minorista",
    business_restaurant: "Restaurante",
    business_distributor: "Distribuidor / mayorista",
    start_free_trial: "Iniciar prueba gratis",
    trial_signup_description: "Crea tu tienda y prueba VENDR gratis por 14 días. No requiere tarjeta.",
    complete_security_check: "Completa la verificación de seguridad para continuar.",
    trial_not_available: "Las pruebas de autoservicio no están disponibles en este momento.",
    start_trial_days: "Iniciar prueba gratis de {days} días",
    trial_check_email: "Revisa tu correo",
    trial_email_sent: "Enviamos un enlace de verificación a {email}. Tu tienda se creará después de verificarlo.",
    trial_link_expires: "El enlace de verificación vence en 30 minutos.",
    trial_verifying: "Creando tu prueba...",
    trial_verifying_description: "Tu correo está verificado. VENDR está preparando tu tienda.",
    trial_verification_failed_title: "No pudimos iniciar la prueba",
    trial_verification_failed: "Este enlace de verificación no es válido o venció. Solicita uno nuevo.",
    trial_banner_days: "Prueba gratis: quedan {days} día(s)",
    trial_banner_read_only: "Tu prueba gratis terminó. Tus datos están seguros y disponibles para consulta, pero los cambios están deshabilitados.",
    trial_landing_eyebrow: "ADMINISTRA TU TIENDA CON MENOS INCERTIDUMBRE",
    trial_landing_heading: "Tu tienda, organizada desde el primer día.",
    trial_landing_subheading: "Ventas, inventario, compras, control de caja e informes claros en un solo espacio práctico para el comercio diario.",
    trial_landing_no_card: "14 días gratis · No requiere tarjeta",
    trial_landing_included: "Todo lo necesario para probar VENDR",
    trial_landing_feature_sales: "Punto de venta rápido con búsqueda de productos e historial auditable.",
    trial_landing_feature_inventory: "Inventario actualizado, alertas de existencias, reposición, ingresos y ajustes.",
    trial_landing_feature_reports: "Rendimiento, rentabilidad e informes semanales basados en tus propios datos.",
    trial_landing_feature_offline: "Protección sin conexión que guarda en cola las operaciones compatibles cuando falla internet.",
    trial_landing_existing_data: "¿Ya usas VENDR? Inicia sesión normalmente. Las tiendas existentes no se ven afectadas por las pruebas.",
    trial_onboarding_eyebrow: "BIENVENIDO A VENDR",
    trial_onboarding_title: "Configura tu primer flujo real",
    trial_onboarding_description: "Comienza con un producto y una venta. Luego podrás explorar todo lo demás cuando el ciclo básico esté claro.",
    trial_onboarding_products: "Crear o importar los primeros productos",
    trial_onboarding_cash: "Establecer el monto inicial de caja",
    trial_onboarding_sale: "Probar una venta en POS",
    trial_onboarding_products_instruction: "Abra Crear, ingrese un producto real y guárdelo. También puede importar una lista de productos.",
    trial_onboarding_cash_instruction: "Seleccione Ajustar caja, elija Aumentar e ingrese el efectivo que se encuentra actualmente en la caja.",
    trial_onboarding_sale_instruction: "Cree un ticket, agregue un producto, revise la cantidad y el precio, y confirme la venta.",
    trial_onboarding_progress: "Configuración: {done} de {total} completados",
    trial_onboarding_continue: "Continuar configuración",
    trial_onboarding_complete: "Su primer flujo está listo",
    trial_onboarding_complete_short: "Configuración completa",
    trial_onboarding_complete_description: "Ha completado el ciclo básico de VENDR. Puede revisar cualquier paso o explorar el resto del sistema.",
    trial_onboarding_later: "Explorar por mi cuenta",
    trial_admin_eyebrow: "ADMINISTRACIÓN DE LA PLATAFORMA",
    trial_admin_title: "Pruebas de autoservicio",
    trial_admin_back: "Volver a VENDR",
    trial_admin_store: "Tienda",
    trial_admin_contact: "Contacto",
    trial_admin_started: "Inicio",
    trial_admin_expires: "Vencimiento",
    trial_admin_status: "Estado",
    trial_admin_active: "Prueba activa",
    trial_admin_expired: "Vencida / solo lectura",
    trial_admin_paid: "Convertida",
    trial_admin_convert: "Marcar como pagada",
    trial_admin_convert_confirm: "¿Convertir {store} en una cuenta pagada? Esto restaura inmediatamente el acceso de escritura.",
    trial_admin_load_failed: "No se pudieron cargar las tiendas de prueba.",
    trial_admin_convert_failed: "No se pudo convertir esta prueba.",
    trial_admin_empty: "Todavía no se han creado pruebas de autoservicio.",
    subscription_admin_title: "Suscripciones",
    subscription_admin_intro: "Controle pruebas, pagos, períodos de renovación y cuentas que requieren atención.",
    subscription_summary_trials: "Pruebas activas",
    subscription_summary_active: "Suscripciones activas",
    subscription_summary_attention: "Requieren atención",
    subscription_filter_attention: "Requieren atención",
    subscription_paid_through: "Pagado hasta",
    subscription_grace_until: "Gracia hasta",
    subscription_last_payment: "Último pago",
    subscription_record_payment: "Registrar pago",
    subscription_history: "Historial de pagos",
    subscription_no_payments: "No se han registrado pagos de suscripción.",
    subscription_payment_failed: "No se pudo registrar el pago.",
    subscription_history_failed: "No se pudo cargar el historial de pagos.",
    subscription_cancel: "Cancelar renovación",
    subscription_cancel_confirm: "¿Cancelar la renovación de {store}? El acceso continúa durante el período pagado, pero no se otorgará período de gracia.",
    subscription_cancel_failed: "No se pudo cancelar la suscripción.",
    subscription_resume: "Reanudar renovación",
    subscription_resume_failed: "No se pudo reanudar la suscripción.",
    subscription_amount: "Monto pagado (USD)",
    subscription_months: "Meses otorgados",
    subscription_months_short: "mes(es)",
    subscription_payment_date: "Fecha de pago",
    subscription_payment_method: "Forma de pago",
    subscription_reference: "Referencia",
    subscription_period: "Período de acceso",
    subscription_method_cash: "Efectivo",
    subscription_method_bank_transfer: "Transferencia bancaria",
    subscription_method_wompi: "Wompi",
    subscription_method_other: "Otro",
    subscription_status_trial_active: "Prueba activa",
    subscription_status_trial_expired: "Prueba vencida",
    subscription_status_paid_unmanaged: "Convertida · sin seguimiento",
    subscription_status_active: "Activa",
    subscription_status_due_soon: "Próxima a vencer",
    subscription_status_grace: "Período de gracia",
    subscription_status_past_due: "Vencida · solo lectura",
    subscription_status_canceled_active: "Cancelada · activa durante el período",
    subscription_status_canceled: "Cancelada · solo lectura",
    subscription_status_inactive: "Inactiva",
    subscription_banner_due_soon: "La renovación de la suscripción vence el {date}.",
    subscription_banner_grace: "El pago está vencido. El acceso continuará hasta el {date}.",
    subscription_banner_read_only: "La suscripción no está activa. Sus datos están seguros y disponibles para consulta, pero los cambios están deshabilitados. Contacte a VENDR para renovar.",
    subscription_banner_canceled: "La suscripción finalizará el {date}. Sus datos seguirán disponibles para consulta.",
    help: "Ayuda",
    help_eyebrow: "SOPORTE DE VENDR",
    help_center: "Centro de ayuda",
    help_intro: "Busque una tarea, abra sus instrucciones y vaya directamente al flujo relacionado.",
    help_search_placeholder: "Buscar preguntas o tareas...",
    help_take_me_there: "Ir a esta función",
    help_watch_tutorial: "Ver tutorial",
    help_no_results: "No hay temas de ayuda que coincidan con la búsqueda.",
...
organization_report_load_failed:
  "No se pudo cargar el reporte de la organización.",
    ...
    ai_reporting_not_enabled: "Los reportes con IA no están habilitados para esta tienda",
    ai_reporting_not_enabled_help: "Habilita la tienda antes de generar su primer resumen semanal.",
    ai_reporting_not_configured: "Los reportes con IA no están configurados",
    ai_reporting_not_configured_help: "Agrega la clave API de OpenAI al entorno del backend antes de generar reportes.",
    ai_report_load_failed: "No se pudieron cargar los reportes semanales.",
    ai_report_generate_failed: "No se pudo generar el reporte semanal.",
    no_weekly_reports: "Aún no hay resúmenes semanales",
    generate_weekly_report_help: "Genera un análisis de la última semana completa de lunes a domingo.",
    generate_weekly_report: "Generar reporte de la semana pasada",
    generating_report: "Generando reporte…",
    report_period: "Período del reporte",
    select_weekly_report: "Seleccionar reporte semanal",
    ...
    concerns: "Puntos de atención",
    no_concerns: "No se identificaron puntos de atención.",
    recommended_actions: "Acciones recomendadas",
    data_limitations: "Limitaciones de los datos",
    ai_report_disclaimer: "Interpretación generada con IA basada únicamente en datos calculados por VENDR. Revisa las recomendaciones antes de actuar.",
    alerts: "Alertas",
    growth: "Crecimiento",
